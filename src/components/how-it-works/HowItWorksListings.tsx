...
const STEPS = [
  ...
  },
  {
    ...
    description:
      "Once approved, the listing is published on halal yums. Details can be updated over time — by the restaurant, the community, or our team — to keep information current.",
  },
];
