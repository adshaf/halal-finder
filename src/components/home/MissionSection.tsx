...
const values = [
  ...
  },
  {
    ...
    description:
      "halal yums grows through community input. Users can suggest restaurants and share information, helping build a directory that reflects the diverse needs of Muslims across Australia.",
  },
  {
    icon: Wand2,
      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-20">
        <div className="text-center max-w-3xl mx-auto mb-20 space-y-4">
          ...
          <p className="text-lg text-slate-400 leading-relaxed text-center">
            halal yums was created to help Muslims in Australia easily discover
