...
export default function Navbar() {
  ...
  return (
    <>
      <header className="fixed top-0 left-0 right-0 z-50 border-b border-gold/10 bg-warm-dark/80 backdrop-blur-md px-6 lg:px-20 py-4">
          ...
          <div className="hidden md:flex items-center gap-6">
            {user ? (
              <div className="relative" ref={dropdownRef}>
                ...
                {dropdownOpen && (
                  <div className="absolute right-0 top-full mt-2 w-48 bg-warm-dark border border-gold/15 rounded-xl shadow-xl overflow-hidden z-50">
                    <Link
                      href="/dashboard"
      ...
      <nav
        className={`fixed top-0 right-0 bottom-0 z-50 w-72 bg-warm-dark border-l border-gold/10 flex flex-col transition-transform duration-300 ease-in-out md:hidden ${
