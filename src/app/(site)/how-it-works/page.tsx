...
export const metadata: Metadata = {
  title: "How It Works | halal yums",
  description:
    "Learn how halal yums works — how listings are added, what the halal badges mean, and what to keep in mind when using the platform.",
};
